package com.fec.core.widget.emptyViews;
...
import com.fec.core.widget.ImageLoaderHelper;
...
public class EmptyView extends FrameLayout {
	...
	public EmptyView(Context context, AttributeSet attrs, int defStyle) {
        ...
        init();
        TypedArray arr = context.obtainStyledAttributes(attrs, R.styleable.EmptyViewStyle);
        Boolean attrShowLoading = arr.getBoolean(R.styleable.EmptyViewStyle_empty_show_loading, false);
        int attrImageView = arr.getInt(R.styleable.EmptyViewStyle_empty_image_view, 0);
        String attrTitleText = arr.getString(R.styleable.EmptyViewStyle_empty_title_text);
        String attrDetailText = arr.getString(R.styleable.EmptyViewStyle_empty_detail_text);
        String attrBtnText = arr.getString(R.styleable.EmptyViewStyle_empty_btn_text);
        arr.recycle();
